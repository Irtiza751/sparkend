...
export class Migration20250803112125 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`alter table "user" alter column "vefified" type boolean using ("vefified"::boolean);`);
    this.addSql(`alter table "user" alter column "vefified" set default false;`);
